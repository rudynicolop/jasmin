...
Module Info.
  ...
  Definition source_file := "../jasmin/compiler/genRocqExamples/whileScope.c".
...
Definition _local : ident := $"local".
Definition _local__1 : ident := $"local__1".
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_local, tint) :: (_i, tint) :: (_local__1, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _local (Eunop Oneg (Econst_int (Int.repr 1) tint) tint))
    (Ssequence
      (Ssequence
        ...
        (Sloop
          (Ssequence
            (Sifthenelse (Ebinop Olt (Etempvar _i tint)
              ...
              Sbreak)
            (Ssequence
              (Sset _local__1 (Etempvar _i tint))
              (Scall None
                (Evar _printf (Tfunction ((tptr tschar) :: nil) tint
                                {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                ((Evar ___stringlit_1 (tarray tschar 20)) ::
                 (Etempvar _local__1 tint) :: nil))))
          (Sset _i
